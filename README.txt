...
this README file, and a zip archive of the entire Maven project and the underlying files, which includes
again all source code along with the tests for the model as well as the UML class diagram.

Inside the zip archive for all the project files:
